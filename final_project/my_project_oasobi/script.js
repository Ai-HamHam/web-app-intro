document.addEventListener('DOMContentLoaded', () => {
    ...
    function createStalker() {
        if (Math.random() < 0.1) {
            ...
            stalker.src = 'images/mendako.png';
            stalker.alt = 'mendako';
            stalker.style.width = '120px';
            stalker.style.height = '120px';
            stalker.style.objectFit = 'contain';
            ...
            function animateStalker() {
                ...
                // マウスに近いか判定（画像サイズの半分以内）
                isNearMouse = distance < 60;
                ...
                if (!isNearMouse) {
                    angle += 0.5; // ゆっくり回転
                    stalker.style.transform = `translate(-50%, -50%) rotate(${angle}deg)`;
                } else {
                    stalker.style.transform = `translate(-50%, -50%)`;
                }
